...
class ServerTestCase(unittest.TestCase):
    # @mock.patch('derms_app.server.derms_client.get_devices')
    @mock.patch('derms_app.server.derms_client')
    ...
    @mock.patch('derms_app.server.group')
    @mock.patch('derms_app.server.get_devices')
    @mock.patch('derms_app.server.render_template')
    @mock.patch('derms_app.server.derms_client')
    @mock.patch('derms_app.server.request')
    def test_create_group_html(self, mock_request, mock_derms_client, mock_teamplate, mock_get_devices, mock_group):
